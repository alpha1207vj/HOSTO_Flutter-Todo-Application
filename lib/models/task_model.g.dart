...
int _taskModelEstimateSize(
  ...
  bytesCount += 3 + object.dateFormatee.length * 3;
  {
...
extension TaskModelQueryFilter
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> dateFormateeEqualTo(
    String value, {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> dateFormateeBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition>
  dateFormateeStartsWith(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition>
  dateFormateeEndsWith(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition>
  dateFormateeContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition> dateFormateeMatches(
    String pattern, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  dateFormateeIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'dateFormatee', value: ''),
      );
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterFilterCondition>
  dateFormateeIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(property: r'dateFormatee', value: ''),
      );
    });
  }
...
extension TaskModelQuerySortBy on QueryBuilder<TaskModel, TaskModel, QSortBy> {
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByDateFormatee() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dateFormatee', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> sortByDateFormateeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dateFormatee', Sort.desc);
    });
  }
...
extension TaskModelQuerySortThenBy
  ...
  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByDateFormatee() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dateFormatee', Sort.asc);
    });
  }

  QueryBuilder<TaskModel, TaskModel, QAfterSortBy> thenByDateFormateeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'dateFormatee', Sort.desc);
    });
  }
...
extension TaskModelQueryWhereDistinct
  ...
  QueryBuilder<TaskModel, TaskModel, QDistinct> distinctByDateFormatee({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'dateFormatee', caseSensitive: caseSensitive);
    });
  }
...
extension TaskModelQueryProperty
  ...
  QueryBuilder<TaskModel, String, QQueryOperations> dateFormateeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'dateFormatee');
    });
  }
